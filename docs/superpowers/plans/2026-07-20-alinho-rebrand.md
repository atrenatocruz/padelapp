...
:root {
  ...
  --muted:   75 85 99;      /* #4B5563 — Dark Gray: "supporting body copy and
                                ...
                                Fixes a gap in the design spec, which mapped
                                court-500 to this same value/role but never
                                explicitly addressed the separate --muted
                                token — left unfixed it would've been the one
                                surviving old-brand color (#5C6B7A). */
